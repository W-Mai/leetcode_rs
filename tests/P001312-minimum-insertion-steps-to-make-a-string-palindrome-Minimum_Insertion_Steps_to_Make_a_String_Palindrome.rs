/**
 * [P001312] Minimum Insertion Steps to Make a String Palindrome
 *
...
// discuss: https://leetcode.com/problems/minimum-insertion-steps-to-make-a-string-palindrome/discuss/
