/**
 * [P001786] Number of Restricted Paths From First to Last Node
 *
...
// discuss: https://leetcode.com/problems/number-of-restricted-paths-from-first-to-last-node/discuss/
