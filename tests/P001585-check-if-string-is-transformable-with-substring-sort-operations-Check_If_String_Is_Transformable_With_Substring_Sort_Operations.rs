/**
 * [P001585] Check If String Is Transformable With Substring Sort Operations
 *
...
// discuss: https://leetcode.com/problems/check-if-string-is-transformable-with-substring-sort-operations/discuss/
