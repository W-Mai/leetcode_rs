/**
 * [P002980] Check if Bitwise OR Has Trailing Zeros
 *
...
// problem: https://leetcode.com/problems/check-if-bitwise-or-has-trailing-zeros/
// discuss: https://leetcode.com/problems/check-if-bitwise-or-has-trailing-zeros/discuss/
