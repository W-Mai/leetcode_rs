/**
 * [P003039] Apply Operations to Make String Empty
 *
...
// problem: https://leetcode.com/problems/apply-operations-to-make-string-empty/
// discuss: https://leetcode.com/problems/apply-operations-to-make-string-empty/discuss/
