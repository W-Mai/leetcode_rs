/**
 * [P001404] Number of Steps to Reduce a Number in Binary Representation to One
 *
...
// discuss: https://leetcode.com/problems/number-of-steps-to-reduce-a-number-in-binary-representation-to-one/discuss/
