/**
 * [P001171] Remove Zero Sum Consecutive Nodes from Linked List
 *
...
// discuss: https://leetcode.com/problems/remove-zero-sum-consecutive-nodes-from-linked-list/discuss/
