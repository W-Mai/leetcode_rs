/**
 * [P002434] Using a Robot to Print the Lexicographically Smallest String
 *
...
// discuss: https://leetcode.com/problems/using-a-robot-to-print-the-lexicographically-smallest-string/discuss/
