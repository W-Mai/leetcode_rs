/**
 * [P001293] Shortest Path in a Grid with Obstacles Elimination
 *
...
// discuss: https://leetcode.com/problems/shortest-path-in-a-grid-with-obstacles-elimination/discuss/
