/**
 * [P001519] Number of Nodes in the Sub-Tree With the Same Label
 *
...
// discuss: https://leetcode.com/problems/number-of-nodes-in-the-sub-tree-with-the-same-label/discuss/
