/**
 * [P003116] Kth Smallest Amount With Single Denomination Combination
 *
...
// discuss: https://leetcode.com/problems/kth-smallest-amount-with-single-denomination-combination/discuss/
