/**
 * [P002535] Difference Between Element Sum and Digit Sum of an Array
 *
...
// discuss: https://leetcode.com/problems/difference-between-element-sum-and-digit-sum-of-an-array/discuss/
