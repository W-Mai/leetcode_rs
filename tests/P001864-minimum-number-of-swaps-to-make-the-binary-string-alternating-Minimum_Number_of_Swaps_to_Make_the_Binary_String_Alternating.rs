/**
 * [P001864] Minimum Number of Swaps to Make the Binary String Alternating
 *
...
// discuss: https://leetcode.com/problems/minimum-number-of-swaps-to-make-the-binary-string-alternating/discuss/
