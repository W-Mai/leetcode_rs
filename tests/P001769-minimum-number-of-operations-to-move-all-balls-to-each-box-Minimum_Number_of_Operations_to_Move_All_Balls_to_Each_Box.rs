/**
 * [P001769] Minimum Number of Operations to Move All Balls to Each Box
 *
...
// discuss: https://leetcode.com/problems/minimum-number-of-operations-to-move-all-balls-to-each-box/discuss/
