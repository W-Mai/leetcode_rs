/**
 * [P001320] Minimum Distance to Type a Word Using Two Fingers
 *
...
// discuss: https://leetcode.com/problems/minimum-distance-to-type-a-word-using-two-fingers/discuss/
