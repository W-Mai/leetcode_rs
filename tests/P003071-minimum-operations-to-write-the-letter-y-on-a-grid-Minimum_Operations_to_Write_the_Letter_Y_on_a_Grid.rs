/**
 * [P003071] Minimum Operations to Write the Letter Y on a Grid
 *
...
// discuss: https://leetcode.com/problems/minimum-operations-to-write-the-letter-y-on-a-grid/discuss/
