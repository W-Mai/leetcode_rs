/**
 * [P001449] Form Largest Integer With Digits That Add up to Target
 *
...
// discuss: https://leetcode.com/problems/form-largest-integer-with-digits-that-add-up-to-target/discuss/
