/**
 * [P002060] Check if an Original String Exists Given Two Encoded Strings
 *
...
// discuss: https://leetcode.com/problems/check-if-an-original-string-exists-given-two-encoded-strings/discuss/
