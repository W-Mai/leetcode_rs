/**
 * [P002839] Check if Strings Can be Made Equal With Operations I
 *
...
// discuss: https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-i/discuss/
