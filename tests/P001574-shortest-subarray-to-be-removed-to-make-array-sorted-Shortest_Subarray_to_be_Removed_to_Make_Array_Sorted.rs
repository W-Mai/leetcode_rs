/**
 * [P001574] Shortest Subarray to be Removed to Make Array Sorted
 *
...
// discuss: https://leetcode.com/problems/shortest-subarray-to-be-removed-to-make-array-sorted/discuss/
