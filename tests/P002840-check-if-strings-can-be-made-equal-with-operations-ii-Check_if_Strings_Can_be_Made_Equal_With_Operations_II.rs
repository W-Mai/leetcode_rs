/**
 * [P002840] Check if Strings Can be Made Equal With Operations II
 *
...
// discuss: https://leetcode.com/problems/check-if-strings-can-be-made-equal-with-operations-ii/discuss/
