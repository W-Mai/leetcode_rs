/**
 * [P001299] Replace Elements with Greatest Element on Right Side
 *
...
// discuss: https://leetcode.com/problems/replace-elements-with-greatest-element-on-right-side/discuss/
