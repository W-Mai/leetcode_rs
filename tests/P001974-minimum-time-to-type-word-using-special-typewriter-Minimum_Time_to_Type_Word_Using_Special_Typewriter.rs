/**
 * [P001974] Minimum Time to Type Word Using Special Typewriter
 *
...
// discuss: https://leetcode.com/problems/minimum-time-to-type-word-using-special-typewriter/discuss/
