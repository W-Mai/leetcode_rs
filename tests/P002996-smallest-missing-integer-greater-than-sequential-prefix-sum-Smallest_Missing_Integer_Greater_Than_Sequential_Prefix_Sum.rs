/**
 * [P002996] Smallest Missing Integer Greater Than Sequential Prefix Sum
 *
...
// discuss: https://leetcode.com/problems/smallest-missing-integer-greater-than-sequential-prefix-sum/discuss/
