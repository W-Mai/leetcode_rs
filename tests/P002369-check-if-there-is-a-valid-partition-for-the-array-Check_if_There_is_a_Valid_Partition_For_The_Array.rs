/**
 * [P002369] Check if There is a Valid Partition For The Array
 *
...
// discuss: https://leetcode.com/problems/check-if-there-is-a-valid-partition-for-the-array/discuss/
