/**
 * [P001758] Minimum Changes To Make Alternating Binary String
 *
...
// discuss: https://leetcode.com/problems/minimum-changes-to-make-alternating-binary-string/discuss/
