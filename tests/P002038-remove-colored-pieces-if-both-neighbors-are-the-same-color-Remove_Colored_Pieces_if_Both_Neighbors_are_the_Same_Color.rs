/**
 * [P002038] Remove Colored Pieces if Both Neighbors are the Same Color
 *
...
// discuss: https://leetcode.com/problems/remove-colored-pieces-if-both-neighbors-are-the-same-color/discuss/
