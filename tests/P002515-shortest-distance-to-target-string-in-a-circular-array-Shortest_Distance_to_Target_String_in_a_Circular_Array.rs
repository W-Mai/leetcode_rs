/**
 * [P002515] Shortest Distance to Target String in a Circular Array
 *
...
// discuss: https://leetcode.com/problems/shortest-distance-to-target-string-in-a-circular-array/discuss/
