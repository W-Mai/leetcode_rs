/**
 * [P002961] Double Modular Exponentiation
 *
...
// problem: https://leetcode.com/problems/double-modular-exponentiation/
// discuss: https://leetcode.com/problems/double-modular-exponentiation/discuss/
