/**
 * [P001850] Minimum Adjacent Swaps to Reach the Kth Smallest Number
 *
...
// discuss: https://leetcode.com/problems/minimum-adjacent-swaps-to-reach-the-kth-smallest-number/discuss/
