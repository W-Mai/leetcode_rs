/**
 * [P003127] Make a Square with the Same Color
 *
...
// problem: https://leetcode.com/problems/make-a-square-with-the-same-color/
// discuss: https://leetcode.com/problems/make-a-square-with-the-same-color/discuss/
